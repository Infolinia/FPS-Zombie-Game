...
namespace DigitalRuby.RainMaker
{
    public class BaseRainScript : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
			...
			audioSourceRainLight.AudioSource.playOnAwake = true;
			//audioSourceRainMedium.AudioSource.playOnAwake = true;
			//audioSourceRainHeavy.AudioSource.playOnAwake = true;
			//audioSourceWind.AudioSource.playOnAwake = true;
            if (RainFallParticleSystem != null)
            {
                ParticleSystem.EmissionModule e = RainFallParticleSystem.emission;
                e.enabled = false;
